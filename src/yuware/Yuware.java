...
public class Yuware extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Drivers");

        jButton18.setText("Install Drivers");
        ...
        googleplusIcon.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                googleplusIconMouseReleased(evt);
            }
        });

        jButton19.setText("Fix Drivers");
        ...
        Devices.add(ByurekaB);
        ByurekaB.setText("Yureka Black");
        ...
        reportBugLabel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reportBugLabelActionPerformed(evt);
            }
        });
        jMenu3.add(reportBugLabel);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, " Yuware is free software for YU devices \n"
                ...
                + "  Version :- 6.0 ", "About", JOptionPane.INFORMATION_MESSAGE, icon);
    ...
    private void reportBugLabelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reportBugLabelActionPerformed
        try {
            Desktop.getDesktop().browse(new URI("http://goo.gl/forms/aXSZa5k8Ip"));
        } catch (URISyntaxException | IOException ex) {
            Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_reportBugLabelActionPerformed

    private void facebookIconMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_facebookIconMouseReleased
        try {
            Desktop.getDesktop().browse(new URI("https://www.facebook.com/TheSomesh"));
        } catch (URISyntaxException | IOException ex) {
            Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_facebookIconMouseReleased

    private void googleplusIconMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_googleplusIconMouseReleased
        try {
            Desktop.getDesktop().browse(new URI("https://plus.google.com/u/0/106205687174772057721/posts"));
        } catch (URISyntaxException | IOException ex) {
            Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_googleplusIconMouseReleased
    ...
    private void ByurekaBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ByurekaBActionPerformed
        Dstatus.setText("");
        DSelected.setText("Yureka-B selected!");
        ByurekaB.setSelected(true);
        try {
            DStatus();
        } catch (IOException ex) {
            Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JToggleButton ByurekaB;
                    ...
                    if ("Fastboot!".equals(tmp)) {
                        ...
                        if (y == JOptionPane.YES_OPTION) {
                            ...
                            try {
                                ...
                                process.waitFor();
                                Desktop.getDesktop().edit(new File("C:/Program Files/Yuware™/Yuphoria_Yutopia_DeviceInfo.txt"));
                                process.destroy();
                            } catch (IOException | InterruptedException ex) {
                                Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
                            }
                            ...
                            try {
                                ...
                                process.waitFor();
                                Desktop.getDesktop().edit(new File("C:/Program Files/Yuware™/Yunique_Yureka-Black_DeviceInfo.txt"));
                                process.destroy();
                            } catch (IOException | InterruptedException ex) {
                                Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
                            }
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            try {
                                ...
                                Process flashing = Runtime.getRuntime().exec("cmd /c start \"Flashing all Partitions on Yuphoria or Yutopia\" yuphoriaflasher.bat", null, new File(choosen.getParent()));
                            } catch (IOException ex) {
                                Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            try {
                                ...
                                Process flashing = Runtime.getRuntime().exec("cmd /c start \"Flashing all Partitions on Yunique or Yureka Black\" yuniqueflasher.bat", null, new File(choosen.getParent()));
                            } catch (IOException ex) {
                                Logger.getLogger(Yuware.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
    ...
    private void changeDPI_function() {
        new Thread() {
            @Override
            public void run() {
                String input, prevVal = "NULL";
                JTextField inputField = new JTextField();
                Process getDPI;
                try {
                    getDPI = Runtime.getRuntime().exec(adbpath.getText() + "\\adb shell wm density");
                    BufferedReader br = new BufferedReader(new InputStreamReader(getDPI.getInputStream()));
                    prevVal = br.readLine();
                } catch (IOException ex) {
                }
                String message = "Changing DPI can brick your device. Be Careful while entering the value.\n"
                        + "Enter DPI here. Value ranges from 200 to 600\n\n                 Current " + prevVal + "\n  ";
                Object obj[] = {message, inputField};
                int y = JOptionPane.showConfirmDialog(Yuware.this, obj, "Warning!", JOptionPane.OK_CANCEL_OPTION);
